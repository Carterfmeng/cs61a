...
def piggy_points(score):
    ...
    squared_score = square(score)
    smallest_digit = squared_score % 10
    squared_score = squared_score // 10
    while squared_score > 0:
        last_digit = squared_score % 10
        squared_score = squared_score // 10
...
def more_boar(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 4
    def leftmost_2digits(score):
        while score // 100 > 0:
            score = score // 10
        return score
    player_score = leftmost_2digits(player_score)
    opponent_score = leftmost_2digits(opponent_score)
